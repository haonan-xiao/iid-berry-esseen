"""Independent source, checkpoint, composition and axiom audit for the overlay.

This is a new explicit contract, not a relaxation of the old 18-root verifier.
Its receipts always retain proofEvidence=false; human/project gates are separate.
"""
...
from verify_path2_final_evidence import (EXPECTED_TASK_PAIRS, FINAL_ROOTS,
