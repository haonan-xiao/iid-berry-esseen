...
def finiteN41Shard0001Tree : DyadicRouteBLeafTree :=
...
theorem finiteN41Shard0001_checked :
    bound4395FiniteTargetAwareVerifyLeafTree
      dyadicRouteBBuildResolutionCache 41 5
        finiteN41Shard0001Tree (dyadicRouteBLeftHalf (dyadicRouteBFiniteRootRho 41)) (dyadicRouteBRightHalf (dyadicRouteBLeftHalf dyadicRouteBFiniteRootZ)) = true := by
