...
def finiteN70Shard0000Tree : DyadicRouteBLeafTree :=
...
theorem finiteN70Shard0000_checked :
    bound4395FiniteTargetAwareVerifyLeafTree
      dyadicRouteBBuildResolutionCache 70 5
        finiteN70Shard0000Tree (dyadicRouteBLeftHalf (dyadicRouteBFiniteRootRho 70)) (dyadicRouteBLeftHalf (dyadicRouteBLeftHalf dyadicRouteBFiniteRootZ)) = true := by
