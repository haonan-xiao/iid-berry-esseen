...
def finiteN73Shard0000Tree : DyadicRouteBLeafTree :=
...
theorem finiteN73Shard0000_checked :
    bound4395FiniteTargetAwareVerifyLeafTree
      dyadicRouteBBuildResolutionCache 73 5
        finiteN73Shard0000Tree (dyadicRouteBLeftHalf (dyadicRouteBFiniteRootRho 73)) (dyadicRouteBLeftHalf (dyadicRouteBLeftHalf dyadicRouteBFiniteRootZ)) = true := by
