...
def finiteN77Shard0000Tree : DyadicRouteBLeafTree :=
...
theorem finiteN77Shard0000_checked :
    bound4395FiniteTargetAwareVerifyLeafTree
      dyadicRouteBBuildResolutionCache 77 5
        finiteN77Shard0000Tree (dyadicRouteBLeftHalf (dyadicRouteBFiniteRootRho 77)) (dyadicRouteBLeftHalf (dyadicRouteBLeftHalf dyadicRouteBFiniteRootZ)) = true := by
