import BerryEsseen.Interval.Arithmetic.Darboux
import BerryEsseen.Interval.Prawitz.FiniteCell
import BerryEsseen.Interval.Prawitz.HQLower

/-!
# Interval / Prawitz / Cell Partition
-/
